...
**Tech stack drop:**
> "Built on Google ADK with Gemini 2.0 Flash via Vertex AI. Deployed as Kubernetes agents using Kagent v1alpha2 CRDs — so it's cloud-agnostic. Swap Gemini for Bedrock or Azure OpenAI by changing two lines of YAML."
